...
/**
 * A dynamic action provider that allows for defining custom actions at runtime.
 * The actions can optionally depend on a WalletProvider.
 */
export class CustomActionProvider<
  TWalletProvider extends WalletProvider
...
export const customActionProvider = <TWalletProvider extends WalletProvider>(
  ...
  new CustomActionProvider<TWalletProvider>(
